...
import { Link, Icon, H2, Contedor} from "./Index";

export default function LinkCompletoMovileComponents(props){
    ...
    return (
        <Contedor position="absolute" left={props.stadoLateral ? "-200" : "0"}>
